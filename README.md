...
<!-- pr-count:start -->
> **199 pull requests merged into 168 repositories**, none of them mine, measured 2026-09-12 by [`sync-pr-count`](.github/workflows/sync-pr-count.yml) &middot; *152 of them merged inside a single month, counted 20 August 2026 when the total was 153. A burst, not a four-year cadence.*
<!-- pr-count:end -->
